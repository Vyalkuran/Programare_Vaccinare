...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().requireCsrfProtectionMatcher(new AntPathRequestMatcher("**/login"))
                ...
                .antMatchers("/profile", "/profile/**").hasAnyAuthority("UTILIZATOR_CREAT", "PROFIL_CREAT")
                .antMatchers("/home", "/beneficiari", "/beneficiari/**", "/programare", "/programare/**", "/beneficiari/**/**", "/programare/**/**").hasAuthority("PROFIL_CREAT")
                .and()
                .formLogin()
